...
/*
* Menu : If extension has custom menu use it else use default
*/
if ($menu == "true") {
    $extensionMenu = 0;
    foreach ($config->extension as $extension) {
...
/*
* Main : If extension has custom layout use it else use default
*/
if (!in_array($module . "_" . $view, $early_exit)) {
    $extensionMain = 0;
    foreach ($config->extension as $extension) {
...
// If no smarty template - add message - only uncomment for dev - commented out for release
if ($extensionTemplates == 0) {
